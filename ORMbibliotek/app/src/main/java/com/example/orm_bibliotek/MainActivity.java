...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextFornavn= findViewById(R.id.fornavn); editTextEtternavn = findViewById(R.id.etternavn);
        visalle=findViewById(R.id.visalle);

        findViewById(R.id.lagre).setOnClickListener(new View.OnClickListener() {@Override
    ...
    private void showUser() {
        class ShowUser extends AsyncTask<Void, Void, List<User>>{
            ...
            protected void onPostExecute(List<User> alle) {
                ...
                String tekst=""; for (User bruker : alle) {
                    tekst = tekst + "Fornavn: " +
